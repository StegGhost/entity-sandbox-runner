...
# Force ingestion before any evaluation logic
try:
    from install.ingestion_v2 import run as run_ingestion
except Exception as e:
    print("INGESTION IMPORT ERROR:", str(e))
    run_ingestion = None
...
def main():
    ...
    if run_ingestion is not None:
        ...
        print("INGESTION SKIPPED: ingestion_v2 not available")
